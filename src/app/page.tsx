  ...
  return (
    <>
      <div className="w-full md:w-2/6 mx-auto p-6">
        <p className="mb-4">
          Hola! 👋 I am a software engineer and problem solver with a passion
          for technology, currently writing solutions for{" "}
          <strong>MaxiSend</strong>. I love developing front-end applications
          using React & Angular, among other technologies – see my full stack
          [link].
        </p>
        <p className="mb-4">
